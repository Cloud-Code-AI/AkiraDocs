...
import { MarkdownEditor } from '@/components/content/articles/MarkdownEditor'
  ...
  return (
    <div className="container mx-auto p-4 space-y-4">
      ...
      <div className="flex justify-between items-center">
        <SegmentedControl
          value={editorMode}
          onValueChange={(value) => setEditorMode(value as 'blocks' | 'markdown')}
          options={[
      ...
      {editorMode === 'blocks' ? (
        ...
        <MarkdownEditor
          ...
          onChange={(newContent) => {
            ...
            setSubtitle(newContent.description)
            setBlocks(newContent.blocks)
          }}
        />
      )}
    </div>
